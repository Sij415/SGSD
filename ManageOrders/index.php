...
<div class="table-responsive d-none d-md-block">
    <table class="table table-striped table-bordered" id="ordersTable">
        <thead>
            <tr>
                <th onclick="sortTable(0)">Order ID <i class="bi bi-arrow-down-up"></i></th>
                <th onclick="sortTable(1)">User ID <i class="bi bi-arrow-down-up"></i></th>
                <th onclick="sortTable(2)">Customer Name <i class="bi bi-arrow-down-up"></i></th>
...
// Change cursor to pointer on hover for sortable columns
