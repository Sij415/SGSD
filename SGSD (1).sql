...
--
-- Host: localhost
-- Generation Time: Mar 03, 2025 at 10:06 PM
...
INSERT INTO `Notifications` (`Notification_ID`, `Role`, `Message`, `Created_At`) VALUES
(1, 'admin', 'system maintenance scheduled for midnight.', '2025-02-28 04:24:04'),
(2, 'staff', 'new company policies have been updated.', '2025-02-28 04:24:04'),
(3, 'driver', 'your vehicle assignment has been updated.', '2025-02-28 04:24:04'),
(4, 'admin', 'security update applied successfully.', '2025-02-28 04:24:04'),
(5, 'staff', 'reminder: monthly staff meeting on friday.', '2025-02-28 04:24:04'),
(6, 'driver', 'check your schedule for upcoming deliveries.', '2025-02-28 04:24:04'),
(7, 'admin', 'backup completed successfully.', '2025-02-28 04:24:04'),
(8, 'staff', 'payroll has been processed.', '2025-02-28 04:24:04'),
(9, 'driver', 'traffic advisory: road closures in your area.', '2025-02-28 04:24:04');
...
ALTER TABLE `Notifications`
  ...
  ADD KEY `fk_notifications_role` (`Role`);
...
--
ALTER TABLE `Notifications`
  ADD CONSTRAINT `fk_notifications_role` FOREIGN KEY (`Role`) REFERENCES `Roles` (`Role`) ON DELETE CASCADE ON UPDATE CASCADE;
